...
from fm.model.layers.layer import FeaturesEmbedding, FeaturesLinear, MultiLayerPerceptron
...
class AutomaticFeatureInteractionModel(torch.nn.Module):
    ...
    def __init__(self, field_dims, embed_dim, normalize,
                 sparse_embedding, atten_embed_dim, num_heads, num_layers, attention_dropout,
                 has_residual=True):
        super().__init__()
...
class AutomaticFeatureInteractionPlusModel(torch.nn.Module):
    """
    A pytorch implementation of AutoInt.
