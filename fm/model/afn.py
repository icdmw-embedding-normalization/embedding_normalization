...
class AdaptiveFactorizationNetwork(torch.nn.Module):
    ...
    def __init__(self, field_dims, embed_dim, normalize, sparse_embedding, LNN_dim, mlp_dims, dropouts):
        super().__init__()
        self.num_fields = len(field_dims)
        self.linear = FeaturesLinear(field_dims, sparse_embedding=sparse_embedding)  # Linear
